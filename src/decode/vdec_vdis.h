...
#define MCFW_IPC_BITS_MAX_FILE_EXTENSION_LENGTH                           (4)
...
typedef struct {
    ...
    UInt32              fileNum;
    UInt32              numChannels; // Numbers of channels
    VdecVdis_res        res[MCFW_IPC_BITS_MAX_FILE_NUM_IN_INI];
    UInt32              chBufSize[MCFW_IPC_BITS_MAX_FILE_NUM_IN_INI];
    VdecVdis_FileInfo   fileInfo[MCFW_IPC_BITS_MAX_FILE_NUM_IN_INI];
    UInt32              frameCnt[MCFW_IPC_BITS_MAX_FILE_NUM_IN_INI];
    VdecVdis_IpcFramesCtrl ipcFrames;
    VdecVdis_TrickPlayMode   gDemo_TrickPlayMode;
